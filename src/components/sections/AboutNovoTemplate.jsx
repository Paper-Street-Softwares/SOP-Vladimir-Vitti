              ...
              <div className="flex flex-wrap mx-auto gap-8 justify-center desktop1:gap-2 desktop1:justify-between desktop1:mt-4 desktop2:mt-8">
                <div className="max-w-[90%] desktop1:max-w-[32%] font-secondFont flex flex-col text-start items-start gap-2 bg-primaryDark p-4 rounded-lg h-fit">
                  ...
                  <p className="text-[12px] text-corOutrosTextosBranca opacity-80">
                    ...
                    administrativa para promover a integridade ética e garantir
                    a segurança jurídica às pessoas e aos empreendedores em todo
                    o cenário brasileiro, levando a expertise de grandes
                    empresas adaptadas aos pequenos negócios.
                  </p>
                </div>
                  ...
                  <p className="text-[12px] text-corOutrosTextosBranca opacity-80">
                    ...
                    <div className="text-[12px] flex ">
                      <ul className="flex flex-col gap-1 text-start">
                        ...
                        <li>
                          • Adaptabilidade (Ju 柔): Flexibilidade para encontrar
                          a solução de compliance mais adequada ao seu negócio.
                        </li>
                        <li>
                          • Eficiência (Seiryoku Zen'yo 精力善用): Máxima
                          entrega com mínimo desperdício de recursos.
                        </li>
                        <li>
                          • Prosperidade Mútua (Jita Kyoei 自他共栄):
                          Crescimento junto com clientes e parceiros.
                        </li>
                      </ul>
                    </div>
                  </p>
